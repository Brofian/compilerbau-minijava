...
public class JavaParser extends Parser {
	...
	public static final int
		...
		RULE_method = 4, RULE_attribute = 5, RULE_variableDeclaration = 6, RULE_constructor = 7, 
		RULE_accessModifier = 8, RULE_classType = 9, RULE_returntype = 10, RULE_type = 11, 
		RULE_parameterList = 12, RULE_parameter = 13, RULE_block = 14, RULE_statement = 15, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"package", "imports", "class", "classbody", "method", "attribute", "variableDeclaration", 
			"constructor", "accessModifier", "classType", "returntype", "type", "parameterList", 
			"parameter", "block", "statement", "expressionStatement", "returnStatement", 
			"ifStatement", "elseifStatement", "elseStatement", "whileStatement", 
			"doWhileStatement", "forStatement", "switchStatement", "switchCase", 
			"breakStatement", "continueStatement", "expression", "objectCreation", 
